...
export default function SignupPage() {
  ...
  function getStrength(): { label: string; level: number } {
    ...
    if (l < 10 && /[A-Z]/.test(password) && /\d/.test(password)) return { label: "Medium", level: 2 };
    if (l >= 10 && /[A-Z]/.test(password) && /\d/.test(password) && /[^A-Za-z0-9]/.test(password)) return { label: "Strong", level: 3 };
  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    if (!agreed) { addToast("You must agree to the terms to continue.", "error"); return; }
    setIsSubmitting(true);
    await new Promise((r) => setTimeout(r, 1400));
    setIsSubmitting(false);
    addToast("Registration service is not connected yet.", "error");
  }
        ...
        <div className="auth-header">
          <div className="auth-logo" aria-hidden="true">
            <svg width="36" height="36" viewBox="0 0 36 36" fill="none">
              <path d="M18 3L5 9v8c0 7.35 5.6 14.21 13 15.93C25.4 31.21 31 24.35 31 17V9L18 3z"
        ...
        <form onSubmit={handleSubmit} className="auth-form" id="signup-form">
          <div className="auth-field">
            ...
            <div className="auth-input-wrap">
              ...
              <input id="signup-name" className="auth-input" type="text" placeholder="Jane Doe"
          ...
          <div className="auth-field">
            ...
            <div className="auth-input-wrap">
              ...
              <input id="signup-email" className="auth-input" type="email" placeholder="you@example.com"
          ...
          <div className="auth-field">
            ...
            <div className="auth-input-wrap">
              ...
              <input id="signup-confirm" className="auth-input"
          ...
          <button className="primary-button auth-submit" type="submit"
            disabled={isSubmitting} id="signup-submit">
            {isSubmitting ? (<><span className="spinner" aria-hidden="true"/>Creating account...</>) : "Create account"}
          </button>
        </form>
